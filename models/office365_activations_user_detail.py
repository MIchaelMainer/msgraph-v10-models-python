...
from ..model.user_activation_counts import UserActivationCounts
from ..one_drive_object_base import OneDriveObjectBase


class Office365ActivationsUserDetail(OneDriveObjectBase):
    ...
    @property
    def user_activation_counts(self):
        """Gets and sets the userActivationCounts
        
        Returns: 
            :class:`UserActivationCountsCollectionPage<onedrivesdk.request.user_activation_counts_collection.UserActivationCountsCollectionPage>`:
                The userActivationCounts
        """
        if "userActivationCounts" in self._prop_dict:
            return UserActivationCountsCollectionPage(self._prop_dict["userActivationCounts"])
        else:
            return None
