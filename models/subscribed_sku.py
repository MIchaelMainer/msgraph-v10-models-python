...
class SubscribedSku(OneDriveObjectBase):
    ...
    def prepaid_units(self):
        ...
        Returns: 
            :class:`LicenseUnitsDetail<onedrivesdk.model.license_units_detail.LicenseUnitsDetail>`:
                The prepaidUnits
        """
        if "prepaidUnits" in self._prop_dict:
            if isinstance(self._prop_dict["prepaidUnits"], OneDriveObjectBase):
