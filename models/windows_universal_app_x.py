...
class WindowsUniversalAppX(OneDriveObjectBase):
    ...
    @property
    def applicable_device_types(self):
        """
        Gets and sets the applicableDeviceTypes
        
        Returns: 
            :class:`WindowsDeviceType<onedrivesdk.model.windows_device_type.WindowsDeviceType>`:
                The applicableDeviceTypes
        """
        if "applicableDeviceTypes" in self._prop_dict:
            if isinstance(self._prop_dict["applicableDeviceTypes"], OneDriveObjectBase):
                return self._prop_dict["applicableDeviceTypes"]
            else :
                self._prop_dict["applicableDeviceTypes"] = WindowsDeviceType(self._prop_dict["applicableDeviceTypes"])
                return self._prop_dict["applicableDeviceTypes"]

        return None

    @applicable_device_types.setter
    def applicable_device_types(self, val):
        self._prop_dict["applicableDeviceTypes"] = val
