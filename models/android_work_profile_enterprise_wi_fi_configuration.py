...
from ..model.android_work_profile_trusted_root_certificate import AndroidWorkProfileTrustedRootCertificate
from ..model.android_work_profile_certificate_profile_base import AndroidWorkProfileCertificateProfileBase
from ..one_drive_object_base import OneDriveObjectBase


class AndroidWorkProfileEnterpriseWiFiConfiguration(OneDriveObjectBase):
    ...
    def root_certificate_for_server_validation(self):
        ...
        Returns: 
            :class:`AndroidWorkProfileTrustedRootCertificate<onedrivesdk.model.android_work_profile_trusted_root_certificate.AndroidWorkProfileTrustedRootCertificate>`:
        ...
        if "rootCertificateForServerValidation" in self._prop_dict:
            if isinstance(self._prop_dict["rootCertificateForServerValidation"], OneDriveObjectBase):
                ...
                self._prop_dict["rootCertificateForServerValidation"] = AndroidWorkProfileTrustedRootCertificate(self._prop_dict["rootCertificateForServerValidation"])
                return self._prop_dict["rootCertificateForServerValidation"]
    ...
    def identity_certificate_for_client_authentication(self):
        ...
        Returns: 
            :class:`AndroidWorkProfileCertificateProfileBase<onedrivesdk.model.android_work_profile_certificate_profile_base.AndroidWorkProfileCertificateProfileBase>`:
        ...
        if "identityCertificateForClientAuthentication" in self._prop_dict:
            if isinstance(self._prop_dict["identityCertificateForClientAuthentication"], OneDriveObjectBase):
                ...
                self._prop_dict["identityCertificateForClientAuthentication"] = AndroidWorkProfileCertificateProfileBase(self._prop_dict["identityCertificateForClientAuthentication"])
                return self._prop_dict["identityCertificateForClientAuthentication"]
