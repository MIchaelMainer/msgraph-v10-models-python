...
from ..model.android_for_work_vpn_connection_type import AndroidForWorkVpnConnectionType
...
class AndroidForWorkVpnConfiguration(OneDriveObjectBase):
    ...
    def connection_type(self):
        ...
        Returns: 
            :class:`AndroidForWorkVpnConnectionType<onedrivesdk.model.android_for_work_vpn_connection_type.AndroidForWorkVpnConnectionType>`:
                The connectionType
        """
        if "connectionType" in self._prop_dict:
            if isinstance(self._prop_dict["connectionType"], OneDriveObjectBase):
                ...
                self._prop_dict["connectionType"] = AndroidForWorkVpnConnectionType(self._prop_dict["connectionType"])
                return self._prop_dict["connectionType"]
