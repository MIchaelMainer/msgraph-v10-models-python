...
from ..model.windows_phone81_trusted_root_certificate import WindowsPhone81TrustedRootCertificate
from ..model.managed_device_certificate_state import ManagedDeviceCertificateState
from ..one_drive_object_base import OneDriveObjectBase


class WindowsPhone81SCEPCertificateProfile(OneDriveObjectBase):
    ...
    def root_certificate(self):
        ...
        Returns: 
            :class:`WindowsPhone81TrustedRootCertificate<onedrivesdk.model.windows_phone81_trusted_root_certificate.WindowsPhone81TrustedRootCertificate>`:
                The rootCertificate
        """
        if "rootCertificate" in self._prop_dict:
            if isinstance(self._prop_dict["rootCertificate"], OneDriveObjectBase):
                ...
                self._prop_dict["rootCertificate"] = WindowsPhone81TrustedRootCertificate(self._prop_dict["rootCertificate"])
                return self._prop_dict["rootCertificate"]
