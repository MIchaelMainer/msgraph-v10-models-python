...
from ..model.workbook_chart_legend_format import WorkbookChartLegendFormat
from ..one_drive_object_base import OneDriveObjectBase


class WorkbookChartLegend(OneDriveObjectBase):
    ...
    def format(self):
        ...
        Returns: 
            :class:`WorkbookChartLegendFormat<onedrivesdk.model.workbook_chart_legend_format.WorkbookChartLegendFormat>`:
                The format
        """
        if "format" in self._prop_dict:
            if isinstance(self._prop_dict["format"], OneDriveObjectBase):
                ...
                self._prop_dict["format"] = WorkbookChartLegendFormat(self._prop_dict["format"])
                return self._prop_dict["format"]
