...
class InferenceClassificationOverride(OneDriveObjectBase):
    ...
    def classify_as(self):
        ...
        if "classifyAs" in self._prop_dict:
            if isinstance(self._prop_dict["classifyAs"], OneDriveObjectBase):
    ...
    def sender_email_address(self):
        ...
        if "senderEmailAddress" in self._prop_dict:
            if isinstance(self._prop_dict["senderEmailAddress"], OneDriveObjectBase):
