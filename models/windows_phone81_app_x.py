...
class WindowsPhone81AppX(OneDriveObjectBase):
    ...
    @property
    def phone_product_identifier(self):
        """
        Gets and sets the phoneProductIdentifier
        
        Returns:
            str:
                The phoneProductIdentifier
        """
        if "phoneProductIdentifier" in self._prop_dict:
            return self._prop_dict["phoneProductIdentifier"]
        else:
            return None

    @phone_product_identifier.setter
    def phone_product_identifier(self, val):
        self._prop_dict["phoneProductIdentifier"] = val

    @property
    def phone_publisher_id(self):
        """
        Gets and sets the phonePublisherId
        
        Returns:
            str:
                The phonePublisherId
        """
        if "phonePublisherId" in self._prop_dict:
            return self._prop_dict["phonePublisherId"]
        else:
            return None

    @phone_publisher_id.setter
    def phone_publisher_id(self, val):
        self._prop_dict["phonePublisherId"] = val
