...
class File(OneDriveObjectBase):
    ...
    def processing_metadata(self):
        """Gets and sets the processingMetadata
        
        Returns: 
            bool:
                The processingMetadata
        """
        if "processingMetadata" in self._prop_dict:
            return self._prop_dict["processingMetadata"]
        else:
            return None

    @processing_metadata.setter
    def processing_metadata(self, val):
        self._prop_dict["processingMetadata"] = val
