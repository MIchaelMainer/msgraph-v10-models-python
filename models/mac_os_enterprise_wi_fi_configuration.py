...
from ..model.mac_os_trusted_root_certificate import MacOSTrustedRootCertificate
from ..model.mac_os_certificate_profile_base import MacOSCertificateProfileBase
from ..one_drive_object_base import OneDriveObjectBase


class MacOSEnterpriseWiFiConfiguration(OneDriveObjectBase):
    ...
    def root_certificate_for_server_validation(self):
        ...
        Returns: 
            :class:`MacOSTrustedRootCertificate<onedrivesdk.model.mac_os_trusted_root_certificate.MacOSTrustedRootCertificate>`:
        ...
        if "rootCertificateForServerValidation" in self._prop_dict:
            if isinstance(self._prop_dict["rootCertificateForServerValidation"], OneDriveObjectBase):
                ...
                self._prop_dict["rootCertificateForServerValidation"] = MacOSTrustedRootCertificate(self._prop_dict["rootCertificateForServerValidation"])
                return self._prop_dict["rootCertificateForServerValidation"]
    ...
    def identity_certificate_for_client_authentication(self):
        ...
        if "identityCertificateForClientAuthentication" in self._prop_dict:
            if isinstance(self._prop_dict["identityCertificateForClientAuthentication"], OneDriveObjectBase):
                ...
                self._prop_dict["identityCertificateForClientAuthentication"] = MacOSCertificateProfileBase(self._prop_dict["identityCertificateForClientAuthentication"])
                return self._prop_dict["identityCertificateForClientAuthentication"]
