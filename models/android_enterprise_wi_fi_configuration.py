...
from ..model.android_trusted_root_certificate import AndroidTrustedRootCertificate
from ..model.android_certificate_profile_base import AndroidCertificateProfileBase
from ..one_drive_object_base import OneDriveObjectBase


class AndroidEnterpriseWiFiConfiguration(OneDriveObjectBase):
    ...
    def root_certificate_for_server_validation(self):
        ...
        Returns: 
            :class:`AndroidTrustedRootCertificate<onedrivesdk.model.android_trusted_root_certificate.AndroidTrustedRootCertificate>`:
        ...
        if "rootCertificateForServerValidation" in self._prop_dict:
            if isinstance(self._prop_dict["rootCertificateForServerValidation"], OneDriveObjectBase):
                ...
                self._prop_dict["rootCertificateForServerValidation"] = AndroidTrustedRootCertificate(self._prop_dict["rootCertificateForServerValidation"])
                return self._prop_dict["rootCertificateForServerValidation"]
    ...
    def identity_certificate_for_client_authentication(self):
        ...
        if "identityCertificateForClientAuthentication" in self._prop_dict:
            if isinstance(self._prop_dict["identityCertificateForClientAuthentication"], OneDriveObjectBase):
                ...
                self._prop_dict["identityCertificateForClientAuthentication"] = AndroidCertificateProfileBase(self._prop_dict["identityCertificateForClientAuthentication"])
                return self._prop_dict["identityCertificateForClientAuthentication"]
