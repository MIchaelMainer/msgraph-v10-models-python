...
from ..model.android_for_work_bind_status import AndroidForWorkBindStatus
from ..model.android_for_work_sync_status import AndroidForWorkSyncStatus
from ..model.android_for_work_enrollment_target import AndroidForWorkEnrollmentTarget
from datetime import datetime
from ..one_drive_object_base import OneDriveObjectBase


class AndroidForWorkSettings(OneDriveObjectBase):
    ...
    def bind_status(self):
        ...
        Returns: 
            :class:`AndroidForWorkBindStatus<onedrivesdk.model.android_for_work_bind_status.AndroidForWorkBindStatus>`:
                The bindStatus
        """
        if "bindStatus" in self._prop_dict:
            if isinstance(self._prop_dict["bindStatus"], OneDriveObjectBase):
                ...
                self._prop_dict["bindStatus"] = AndroidForWorkBindStatus(self._prop_dict["bindStatus"])
                return self._prop_dict["bindStatus"]
    ...
    def last_app_sync_status(self):
        ...
        Returns: 
            :class:`AndroidForWorkSyncStatus<onedrivesdk.model.android_for_work_sync_status.AndroidForWorkSyncStatus>`:
        ...
        if "lastAppSyncStatus" in self._prop_dict:
            if isinstance(self._prop_dict["lastAppSyncStatus"], OneDriveObjectBase):
                ...
                self._prop_dict["lastAppSyncStatus"] = AndroidForWorkSyncStatus(self._prop_dict["lastAppSyncStatus"])
                return self._prop_dict["lastAppSyncStatus"]
    ...
    def enrollment_target(self):
        ...
        Returns: 
            :class:`AndroidForWorkEnrollmentTarget<onedrivesdk.model.android_for_work_enrollment_target.AndroidForWorkEnrollmentTarget>`:
        ...
        if "enrollmentTarget" in self._prop_dict:
            if isinstance(self._prop_dict["enrollmentTarget"], OneDriveObjectBase):
                ...
                self._prop_dict["enrollmentTarget"] = AndroidForWorkEnrollmentTarget(self._prop_dict["enrollmentTarget"])
                return self._prop_dict["enrollmentTarget"]
