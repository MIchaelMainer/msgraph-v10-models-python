...
class Device(OneDriveObjectBase):
    ...
    def alternative_security_ids(self):
        ...
        Returns: 
            :class:`AlternativeSecurityIdsCollectionPage<onedrivesdk.request.alternative_security_ids_collection.AlternativeSecurityIdsCollectionPage>`:
    ...
    def registered_owners(self):
        ...
        Returns: 
            :class:`RegisteredOwnersCollectionPage<onedrivesdk.request.registered_owners_collection.RegisteredOwnersCollectionPage>`:
    ...
    def registered_users(self):
        ...
        Returns: 
            :class:`RegisteredUsersCollectionPage<onedrivesdk.request.registered_users_collection.RegisteredUsersCollectionPage>`:
                The registeredUsers
        """
