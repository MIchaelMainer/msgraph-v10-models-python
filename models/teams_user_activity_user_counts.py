...
class TeamsUserActivityUserCounts(OneDriveObjectBase):
    ...
    def other_actions(self):
        """
        Gets and sets the otherActions
        
        Returns:
            int:
                The otherActions
        """
        if "otherActions" in self._prop_dict:
            return self._prop_dict["otherActions"]
        else:
            return None

    @other_actions.setter
    def other_actions(self, val):
        self._prop_dict["otherActions"] = val
