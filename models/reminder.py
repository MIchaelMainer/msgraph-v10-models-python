...
class Reminder(OneDriveObjectBase):
    ...
    def event_start_time(self):
        ...
        if "eventStartTime" in self._prop_dict:
            if isinstance(self._prop_dict["eventStartTime"], OneDriveObjectBase):
    ...
    def event_end_time(self):
        ...
        if "eventEndTime" in self._prop_dict:
            if isinstance(self._prop_dict["eventEndTime"], OneDriveObjectBase):
    ...
    def event_location(self):
        ...
        if "eventLocation" in self._prop_dict:
            if isinstance(self._prop_dict["eventLocation"], OneDriveObjectBase):
    ...
    def reminder_fire_time(self):
        ...
        if "reminderFireTime" in self._prop_dict:
            if isinstance(self._prop_dict["reminderFireTime"], OneDriveObjectBase):
