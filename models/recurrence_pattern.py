...
class RecurrencePattern(OneDriveObjectBase):
    ...
    def type(self):
        ...
        Returns: 
            :class:`RecurrencePatternType<onedrivesdk.model.recurrence_pattern_type.RecurrencePatternType>`:
                The type
        """
    ...
    def first_day_of_week(self):
        ...
        if "firstDayOfWeek" in self._prop_dict:
            if isinstance(self._prop_dict["firstDayOfWeek"], OneDriveObjectBase):
    ...
    def index(self):
        ...
        Returns: 
            :class:`WeekIndex<onedrivesdk.model.week_index.WeekIndex>`:
                The index
        """
        if "index" in self._prop_dict:
            if isinstance(self._prop_dict["index"], OneDriveObjectBase):
