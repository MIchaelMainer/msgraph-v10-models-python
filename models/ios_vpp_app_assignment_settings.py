...
class IosVppAppAssignmentSettings(OneDriveObjectBase):

    def __init__(self, prop_dict={}):
        self._prop_dict = prop_dict

    @property
    def use_device_licensing(self):
        """Gets and sets the useDeviceLicensing
        
        Returns: 
            bool:
                The useDeviceLicensing
        """
        if "useDeviceLicensing" in self._prop_dict:
            return self._prop_dict["useDeviceLicensing"]
        else:
            return None

    @use_device_licensing.setter
    def use_device_licensing(self, val):
        self._prop_dict["useDeviceLicensing"] = val
