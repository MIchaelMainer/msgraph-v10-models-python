...
from ..model.android_work_profile_required_password_type import AndroidWorkProfileRequiredPasswordType
from ..model.android_work_profile_cross_profile_data_sharing_type import AndroidWorkProfileCrossProfileDataSharingType
from ..model.android_work_profile_default_app_permission_policy_type import AndroidWorkProfileDefaultAppPermissionPolicyType
from ..one_drive_object_base import OneDriveObjectBase


class AndroidWorkProfileGeneralDeviceConfiguration(OneDriveObjectBase):
    ...
    def password_required_type(self):
        ...
        Returns: 
            :class:`AndroidWorkProfileRequiredPasswordType<onedrivesdk.model.android_work_profile_required_password_type.AndroidWorkProfileRequiredPasswordType>`:
        ...
        if "passwordRequiredType" in self._prop_dict:
            if isinstance(self._prop_dict["passwordRequiredType"], OneDriveObjectBase):
                ...
                self._prop_dict["passwordRequiredType"] = AndroidWorkProfileRequiredPasswordType(self._prop_dict["passwordRequiredType"])
                return self._prop_dict["passwordRequiredType"]
    ...
    def work_profile_data_sharing_type(self):
        ...
        Returns: 
            :class:`AndroidWorkProfileCrossProfileDataSharingType<onedrivesdk.model.android_work_profile_cross_profile_data_sharing_type.AndroidWorkProfileCrossProfileDataSharingType>`:
        ...
        if "workProfileDataSharingType" in self._prop_dict:
            if isinstance(self._prop_dict["workProfileDataSharingType"], OneDriveObjectBase):
                ...
                self._prop_dict["workProfileDataSharingType"] = AndroidWorkProfileCrossProfileDataSharingType(self._prop_dict["workProfileDataSharingType"])
                return self._prop_dict["workProfileDataSharingType"]
    ...
    def work_profile_default_app_permission_policy(self):
        ...
        Returns: 
            :class:`AndroidWorkProfileDefaultAppPermissionPolicyType<onedrivesdk.model.android_work_profile_default_app_permission_policy_type.AndroidWorkProfileDefaultAppPermissionPolicyType>`:
        ...
        if "workProfileDefaultAppPermissionPolicy" in self._prop_dict:
            if isinstance(self._prop_dict["workProfileDefaultAppPermissionPolicy"], OneDriveObjectBase):
                ...
                self._prop_dict["workProfileDefaultAppPermissionPolicy"] = AndroidWorkProfileDefaultAppPermissionPolicyType(self._prop_dict["workProfileDefaultAppPermissionPolicy"])
                return self._prop_dict["workProfileDefaultAppPermissionPolicy"]
    ...
    def work_profile_password_required_type(self):
        ...
        if "workProfilePasswordRequiredType" in self._prop_dict:
            if isinstance(self._prop_dict["workProfilePasswordRequiredType"], OneDriveObjectBase):
                ...
                self._prop_dict["workProfilePasswordRequiredType"] = AndroidWorkProfileRequiredPasswordType(self._prop_dict["workProfilePasswordRequiredType"])
                return self._prop_dict["workProfilePasswordRequiredType"]
