...
class MobileAppTroubleshootingAppTargetHistory(OneDriveObjectBase):
    ...
    def security_group_id(self):
        """Gets and sets the securityGroupId
        
        Returns: 
            str:
                The securityGroupId
        """
        if "securityGroupId" in self._prop_dict:
            return self._prop_dict["securityGroupId"]
        else:
            return None

    @security_group_id.setter
    def security_group_id(self, val):
        self._prop_dict["securityGroupId"] = val
