...
class MacOSCompliancePolicy(OneDriveObjectBase):
    ...
    def system_integrity_protection_enabled(self):
        """
        Gets and sets the systemIntegrityProtectionEnabled
        
        Returns:
            bool:
                The systemIntegrityProtectionEnabled
        """
        if "systemIntegrityProtectionEnabled" in self._prop_dict:
            return self._prop_dict["systemIntegrityProtectionEnabled"]
        else:
            return None

    @system_integrity_protection_enabled.setter
    def system_integrity_protection_enabled(self, val):
        self._prop_dict["systemIntegrityProtectionEnabled"] = val
