...
class SharePointActivityUserCounts(OneDriveObjectBase):
    ...
    def visited_page(self):
        """
        Gets and sets the visitedPage
        
        Returns:
            int:
                The visitedPage
        """
        if "visitedPage" in self._prop_dict:
            return self._prop_dict["visitedPage"]
        else:
            return None

    @visited_page.setter
    def visited_page(self, val):
        self._prop_dict["visitedPage"] = val
