...
from ..model.android_for_work_app_configuration_schema_item_data_type import AndroidForWorkAppConfigurationSchemaItemDataType
from ..model.key_value_pair import KeyValuePair
from ..one_drive_object_base import OneDriveObjectBase


class AndroidForWorkAppConfigurationSchemaItem(OneDriveObjectBase):
    ...
    def data_type(self):
        ...
        Returns: 
            :class:`AndroidForWorkAppConfigurationSchemaItemDataType<onedrivesdk.model.android_for_work_app_configuration_schema_item_data_type.AndroidForWorkAppConfigurationSchemaItemDataType>`:
                The dataType
        """
        if "dataType" in self._prop_dict:
            if isinstance(self._prop_dict["dataType"], OneDriveObjectBase):
                ...
                self._prop_dict["dataType"] = AndroidForWorkAppConfigurationSchemaItemDataType(self._prop_dict["dataType"])
                return self._prop_dict["dataType"]
