...
from ..model.android_work_profile_vpn_connection_type import AndroidWorkProfileVpnConnectionType
...
class AndroidWorkProfileVpnConfiguration(OneDriveObjectBase):
    ...
    def connection_type(self):
        ...
        Returns: 
            :class:`AndroidWorkProfileVpnConnectionType<onedrivesdk.model.android_work_profile_vpn_connection_type.AndroidWorkProfileVpnConnectionType>`:
                The connectionType
        """
        if "connectionType" in self._prop_dict:
            if isinstance(self._prop_dict["connectionType"], OneDriveObjectBase):
                ...
                self._prop_dict["connectionType"] = AndroidWorkProfileVpnConnectionType(self._prop_dict["connectionType"])
                return self._prop_dict["connectionType"]
    ...
    def identity_certificate(self):
        ...
        if "identityCertificate" in self._prop_dict:
            if isinstance(self._prop_dict["identityCertificate"], OneDriveObjectBase):
                ...
                self._prop_dict["identityCertificate"] = AndroidWorkProfileCertificateProfileBase(self._prop_dict["identityCertificate"])
                return self._prop_dict["identityCertificate"]
