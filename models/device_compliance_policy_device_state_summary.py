...
class DeviceCompliancePolicyDeviceStateSummary(OneDriveObjectBase):

    def __init__(self, prop_dict={}):
        self._prop_dict = prop_dict

    @property
    def in_grace_period_count(self):
        """
        Gets and sets the inGracePeriodCount
        
        Returns:
            int:
                The inGracePeriodCount
        """
    ...
    def in_grace_period_count(self, val):
        self._prop_dict["inGracePeriodCount"] = val

    @property
    def config_manager_count(self):
        """
        Gets and sets the configManagerCount
        
        Returns:
            int:
                The configManagerCount
        """
    ...
    def config_manager_count(self, val):
        self._prop_dict["configManagerCount"] = val
