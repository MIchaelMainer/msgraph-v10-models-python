...
from ..model.android_for_work_app_configuration_schema_item import AndroidForWorkAppConfigurationSchemaItem
from ..one_drive_object_base import OneDriveObjectBase


class AndroidForWorkAppConfigurationSchema(OneDriveObjectBase):
